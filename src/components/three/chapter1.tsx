...
const Chapter1 = () => {
    ...
    const mountTexture = useTexture('/textures/chapter-1/monting.png')
  ...
  return (
    <group position={[0.2, -0.2, 0]}>
        ...
        {/* Mounting */}
        <mesh  position={[0.25, -0.2, -4.5]}>
            <planeGeometry args={[3, 2]} />
            <meshBasicMaterial color='white' transparent map={mountTexture} depthTest={false} depthWrite={false} />
        </mesh>
    </group>
  )
}
